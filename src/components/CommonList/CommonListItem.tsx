...
import { ListItem, IconButton, ListItemButton, ListItemAvatar, Avatar, ListItemText } from '@mui/material'
        ...
        <ListItemAvatar>
          {
            (item.thumbnails && item.thumbnails[0])
              ? <Avatar variant="square" alt={item.fileName} src={item.thumbnails[0].small.url} imgProps={{ loading: 'lazy' }} />
