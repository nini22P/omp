import { Breadcrumbs, Button, Grid, ListItem, ListItemButton, ListItemIcon, ListItemText, Paper, Typography } from "@mui/material"
 ...
 */
  const path = useMemo(
    () => {
      return (folderTree.join('/') === 'Home') ? '/' : folderTree.slice(1).join('/')
    }, [folderTree])
